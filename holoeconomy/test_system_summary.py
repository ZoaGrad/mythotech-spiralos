...
class TestSystemSummary(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.minting_engine = ScarCoinMintingEngine(multiplier=Decimal("1000"), min_delta_c=Decimal("0.01"))
        ...
        self.summarizer = SystemSummary(
            minting_engine=self.minting_engine, empathy_market=self.empathy_market, vaultnode=self.vaultnode
        )
    ...
    def test_summary_with_activity(self):
        ...
        self.minting_engine.mint_scarcoin(
    ...
    def test_create_summary_convenience_function(self):
        ...
        summary = create_summary_from_engines(
            minting_engine=self.minting_engine, vaultnode=self.vaultnode, empathy_market=self.empathy_market
        )
...
class TestSystemSummaryIntegration(unittest.TestCase):
    ...
    def test_full_system_workflow(self):
        ...
        empathy_market.create_wallet("participant_1")
        empathy_market.create_wallet("participant_2")
        ...
        empathy_market.mint_emp_token(resonance_event=resonance_event, peer_validations=["peer1", "peer2", "peer3"])
        ...
        self.assertGreater(summary["components"]["scarcoin"]["activity"]["minting_count"], 0)
        self.assertGreater(summary["components"]["empathy_market"]["tokens"]["total_resonance_events"], 0)
