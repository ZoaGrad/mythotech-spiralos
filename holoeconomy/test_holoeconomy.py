...
from scarcoin import ScarCoinMintingEngine, Wallet
from vaultnode import MerkleTree, VaultEvent, VaultNode
...
def test_vaultnode_blockchain():
    ...
    # Add events
    event1 = VaultEvent(event_type="test_event_1", event_data={"test": "data1"})
    event2 = VaultEvent(event_type="test_event_2", event_data={"test": "data2"})
