...
class TestScarIndexOracle(unittest.TestCase):
    ...
    def test_get_latest_scarindex_success(self, mock_supabase):
        ...
        result_chain = mock_supabase.table.return_value.select.return_value.order.return_value.limit.return_value
        result_chain.execute.return_value.data = mock_data
    ...
    def test_get_latest_scarindex_not_found(self, mock_supabase):
        ...
        # Arrange
        empty_chain = mock_supabase.table.return_value.select.return_value.order.return_value.limit.return_value
        empty_chain.execute.return_value.data = []
    ...
    def test_compute_scarindex_logic_success(self, mock_supabase):
        ...
        mock_rpc_response_data = {"id": str(calc_id), "scarindex": 0.82, "ache_event_id": str(event_id)}
