...
class SystemSummary:
    ...
    def __init__(self, minting_engine=None, empathy_market=None, vaultnode=None, spiralos_core=None):
        """
    ...
    def _get_core_summary(self) -> Dict:
        ...
        return {
            ...
            "pid_controller": {"guidance_scale": status["pid_controller"]["guidance_scale"]},
        }
    ...
    def _get_scarcoin_summary(self) -> Dict:
        ...
        return {
            ...
            "supply": {
                ...
                "circulating": str(Decimal(stats["total_minted"]) - Decimal(stats["total_burned"])),
            },
            "activity": {
    ...
    def _get_empathy_summary(self) -> Dict:
        ...
        return {
            ...
            "participation": {"total_participants": stats["total_participants"]},
            "thresholds": {
    ...
    def _get_vaultnode_summary(self) -> Dict:
        ...
        return {
            ...
            "pending": {"pending_events": stats["pending_events"]},
        }
    ...
    def _determine_overall_status(self) -> str:
        ...
        components_available = sum(
            [self.spiralos_core is not None, self.minting_engine is not None, self.vaultnode is not None]
        )
    ...
    def _calculate_health_metrics(self) -> Dict:
        ...
        if self.spiralos_core:
            ...
            coherence_score = {"OPTIMAL": 1.0, "STRONG": 0.8, "MODERATE": 0.6, "WEAK": 0.4, "CRITICAL": 0.2}.get(
                coherence_status, 0.5
            )
...
def create_summary_from_engines(minting_engine=None, empathy_market=None, vaultnode=None, spiralos_core=None) -> Dict:
    """
    ...
    summarizer = SystemSummary(
        minting_engine=minting_engine, empathy_market=empathy_market, vaultnode=vaultnode, spiralos_core=spiralos_core
    )
