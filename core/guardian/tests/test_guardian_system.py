...
try:
    from analytics.advanced_analytics import CoherenceBreakdown, GuardianAnalytics, TrendAnalysis
...
class TestGuardianBot(unittest.TestCase):
    ...
    def test_status_embed_creation_healthy(self):
        ...
        metrics = GuardianMetrics(
            ...
            scar_status="🟢",
            scar_score=0.912,
            coherence_components={"narrative": 0.89, "social": 0.85, "economic": 0.91, "technical": 0.88},
        )
    ...
    def test_panic_embed_creation(self):
        ...
        metrics = GuardianMetrics(
            ...
            scar_status="🔴",
            scar_score=0.287,
            coherence_components={"narrative": 0.42, "social": 0.28, "economic": 0.19, "technical": 0.31},
        )
...
class TestGuardianAnalytics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.analytics = GuardianAnalytics(supabase_url="https://test.supabase.co", supabase_key="test_key")
    ...
    def test_anomaly_detection(self):
        ...
        df = pd.DataFrame({"created_at": dates, "value": values})
